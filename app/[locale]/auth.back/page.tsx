...
export default function AuthPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-primary-50 via-background to-secondary-50 dark:from-primary-950 dark:via-background dark:to-secondary-950 p-4">
      ...
      <div className="max-w-md w-full bg-white dark:bg-background/80 backdrop-blur-sm p-8 rounded-xl shadow-xl relative z-10">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          ...
          <div className="text-center px-4 group">
            ...
            <h3 className="text-lg font-semibold text-foreground">Sécurisé</h3>
            <p className="text-sm text-muted-foreground">Protection avancée</p>
          </div>
          <div className="text-center px-4 group">
            ...
            <h3 className="text-lg font-semibold text-foreground">Puissant</h3>
