      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("channelsPerNode", {
                count: formatNumber(currentStats?.avg_channels_per_node || 0),
              })}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("capacityPerChannel", {
                amount: formatBitcoin(
                  currentStats?.avg_capacity_per_channel || 0
                ),
              })}
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("lastUpdate", {
                date: new Date(currentStats?.timestamp || "").toLocaleString(),
              })}
            </p>
          </CardContent>
        </Card>
