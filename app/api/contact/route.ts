...
function generateAdminNotificationEmail(data: ContactData): string {
  const subjectLabels: Record<string, any> = {
  ...
  return `
    ...
    <head>
      <style>
        body { font-family: Aria, sans-serif; line-height: 1.6; color: #333; }
...
function generateUserConfirmationEmail(data: Pick<ContactData>): string {
  const subjectLabels: Record<string, any> = {
    "dazpay": "Dazpay - Solution de paiement",
    "support": "Support technique",
    "conseil": "Demande de conseil",
  ...
  return `
    ...
    <head>
      <style>
        body { font-family: Aria, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Notre équipe l'examine attentivement.</p>
          
          <div class="message-preview">
            <h3 style="margin-top: 0;">Rappel de votre message</h3>
            <p>${data.message.replace(/n/g, "<br>")}</p>
          </div>
          ...
          <ul>
            ...
            <li>Découvrir nos solutions sur <a href="https://dazno.de">Daznode</a></li>
          </ul>
