...
import { mockCurrentStats } from "@/lib/mockData";
...
export async function GET() {
  try {
    ...
    console.log("API stats/current route: statistiques récupérées avec succès");
    ...
    if (USE_MOCK_DATA) {
      ...
      return NextResponse.json(mockCurrentStats);
    }
