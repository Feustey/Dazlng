    ...
    <section className="relative min-h-screen bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 flex items-center justify-center px-4 py-20">
      ...
      <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-6 text-white">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-orange-100">{t('ClientHero.30_sur_votre_premire_dazbox')}</p>
              </div>
          ...
          <div className="flex items-center justify-center lg:justify-start gap-3 text-blue-100 text-sm">
            ...
            <span>{t('ClientHero.garantie_satisfait_ou_rembours')}</span>
          </div>
        </div>
          ...
          <div className="relative mx-auto max-w-md lg:max-w-none">
            ...
            <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <Image
                ...
                alt="ClientHero.clientheroclientherodazbox_nud"
                width={400}
                height={300}
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="text-white/60 text-center">
          <p className="text-sm mb-2">{t('ClientHero.dcouvrir_les_fonctionnalits')}</p>
