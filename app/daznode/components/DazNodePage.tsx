        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('DazNodePage.ia_doptimisation')}</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('DazNodePage.analytics_avancs')}</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('DazNodePage.scurit_enterprise')}</h3>
              <p className="text-gray-600">
