...
// Implémentation locale du service MCP de base
const basicMcpService = {
  testConnection: async () => {
    // Toujours retourner false pour utiliser les données simulées
    return false;
  },
  getTopCentralities: async () => {
    // Cette fonction ne sera pas appelée puisque testConnection retourne false
    return {};
  },
};
...
const USE_MOCK_DATA = true; // Forcer l'utilisation des données fictives
