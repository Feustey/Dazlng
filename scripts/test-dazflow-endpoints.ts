  ...
  try {
    ...
    try {
      ...
      console.log('✅ Courbe de fiabilité récupérée:', {
        ...
        premier_point: reliabilityCurve[0] ? {
          montant: reliabilityCurve[0].amount,
    ...
    try {
      ...
      console.log('✅ Santé du réseau évaluée:', {
        capacité_moyenne: networkHealth.global_metrics.average_dazflow_capacity,
    ...
    try {
      ...
      console.log('✅ Optimisation DazFlow réalisée:', {
        id_optimisation: optimizationResult.optimization_id,
