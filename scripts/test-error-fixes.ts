...
// 1. Vérifier que l'image hero-bg.jpg n'est plus référencée
...
webVitalsFiles.forEach(file => {
  if (fs.existsSync(file)) {
    ...
    if (content.includes('import(\'web-vitals\')')) {
      ...
      console.log(`❌ ${file} n'utilise pas l'import dynamique web-vitals`);
    }
  } else {
...
// 5. Vérifier qu'il n'y a qu'un seul PerformanceProvider
