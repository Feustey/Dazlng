  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'body-testimonials': ['20px', { lineHeight: '30px', fontWeight: '400' }],
        'body-testimonials-bold': ['20px', { lineHeight: '30px', fontWeight: '700' }],
        'button': ['18px', { lineHeight: '28px', fontWeight: '400', letterSpacing: '0.5px' }],
        'label-input': ['14px', { fontWeight: '700' }],
        'link-desktop': ['16px', { lineHeight: '24px', fontWeight: '700' }],
        'h1': ['64px', { lineHeight: '80px', fontWeight: '400' }],
        'h2': ['40px', { lineHeight: '48px', fontWeight: '400' }],
        'h3': ['32px', { lineHeight: '40px', fontWeight: '400' }],
        'h4': ['24px', { lineHeight: '30px', fontWeight: '400' }],
        'h5': ['20px', { lineHeight: '24px', fontWeight: '400' }],
        'h6': ['18px', { lineHeight: '22px', fontWeight: '400' }],
      },
      boxShadow: {
