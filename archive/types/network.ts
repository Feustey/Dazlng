...
/**
 * Type étendu de NetworkChannel avec des propriétés supplémentaires pour l'interface utilisateur
 */
export interface Channel extends NetworkChannel {
  /** Identifiant unique du canal */
  id: string;
  /** Identifiant du nœud distant */
  remoteNodeId: string;
  /** Âge du canal en jours */
  age: number;
}
