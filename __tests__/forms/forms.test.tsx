...
describe('Form Tests', () => {
  ...
  describe('PaymentForm', () => {
    it('devrait valider et soumettre le formulaire de paiement', async () => {
      const mockSubmit = jest.fn();
      const { getByLabelText, getByText } = render(<PaymentForm onSubmit={mockSubmit} />);

      fireEvent.change(getByLabelText(/numéro de carte/i), { target: { value: '4242424242424242' } });
      fireEvent.change(getByLabelText(/date d'expiration/i), { target: { value: '12/25' } });
