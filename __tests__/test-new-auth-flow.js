...
async function testNewAuthFlow() {
  ...
  try {
    ...
    console.log(`🔒 Dashboard protégé: ${dashboardResponse.status} (${dashboardResponse.status === 302 ? 'Redirection OK' : 'Pas de redirectio\n})`);
    ...
    console.log('1. Aller sur http://localhost:3001/auth/logi\n);
